      ...
      <div className="container">
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/Cybersecurity.jpeg" alt="" />
          </div>
        ...
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/UIUX.jpeg" alt="" />
          </div>
          <div className="body-container">
            <div className="overlay"></div>
            <div className="event-info">
        ...
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/Web Development.jpeg" alt="" />
          </div>
          <div className="body-container">
            <div className="overlay"></div>
            <div className="event-info">
        ...
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/Mobile dev.jpeg" alt="" />
          </div>
          <div className="body-container">
            <div className="overlay"></div>
            <div className="event-info">
        ...
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/Cloud Computing.jpeg" alt="" />
          </div>
          <div className="body-container">
            <div className="overlay"></div>
            <div className="event-info">
        ...
        <div className="item-container">
          <div className="img-container">
            <img src="../../src/assets/Events/Power platform.jpeg" alt="" />
          </div>
          <div className="body-container">
            <div className="overlay"></div>
            <div className="event-info">
