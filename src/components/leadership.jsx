        ...
        <div className="big_three">
          <div className="card0">
            <img
              ...
              src= "../../src/assets/officials/student3.jpeg"
          ...
          <div className="card0">
            <img
              className="img-leadership"
              src= "../../src/assets/officials/student2.jpeg"
          ...
          <div className="card0">
            <img
              className="img-leadership"
              src= "../../src/assets/officials/student1.jpeg"
              alt=""
            />
            <h3>Allan</h3>
        ...
        <div className="executives">
          <div className="executive-cards">
            <div className="card1">
              <img
                className="img-leadership"
                src= "../../src/assets/officials/student5.jpeg"
